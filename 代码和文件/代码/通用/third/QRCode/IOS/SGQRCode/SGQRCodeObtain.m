...
//    /****************横版 旋转相机************************/
//    [videoPreviewLayer connection].videoOrientation = AVCaptureVideoOrientationLandscapeRight;//旋转相机
//     /****************横版 旋转相机************************/
//    // 保持纵横比，填充层边界
...
//    [controller.view.layer insertSublayer:videoPreviewLayer atIndex:0];
       ...
       /****************横版 旋转相机************************/
//       [_videoPreviewLayer connection].videoOrientation = AVCaptureVideoOrientationLandscapeRight;//旋转相机
        [self changeVideoImagerientation];
        /****************横版 旋转相机************************/
       // 保持纵横比，填充层边界
       _videoPreviewLayer.videoGravity = AVLayerVideoGravityResizeAspectFill;
       _videoPreviewLayer.frame = controller.view.frame;
       [controller.view.layer insertSublayer:_videoPreviewLayer atIndex:0];
}
...
- (void)changeVideoImagerientation{
//    UIDeviceOrientation deviceOrientation = [UIDevice currentDevice].orientation;
    ...
    if(QRCodeIsLanspace){
        if(deviceOrientation == UIDeviceOrientationLandscapeLeft){
            ...
            [_videoPreviewLayer connection].videoOrientation = AVCaptureVideoOrientationLandscapeLeft;//旋转相机
        }
    }else{
