...
package org.cocos2dx.google.zxing.camera;
    ...
    public PlanarYUVLuminanceSource buildLuminanceSource(byte[] data, int width, int height) {
        ...
        switch (previewFormat) {
            ...
            case PixelFormat.YCbCr_422_SP:
                ...
                return new PlanarYUVLuminanceSource(data, height, width, 0, 0, height, width);
            default:
...
//                }
//            source = new PlanarYUVLuminanceSource(rotatedData, newWidth, newHeight, rect.left, rect.top, rect.width(), rect.height());
//        }
//        else {
//            source = new PlanarYUVLuminanceSource(data, width, height, rect.left, rect.top, rect.width(), rect.height());
//            }
//        return source;
    }
